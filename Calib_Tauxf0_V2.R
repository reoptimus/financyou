...
{ #debut fonction
  ...
  # reptravail<-'\\\\intra/partages/UA2771_Data/3_ST_top-down/3.2_En_Cours/6. ESG_V2/2. Organisation scripts/R4 CALIBRAGE'
  ...
  # Data :ligne 11-160
  # EURO: col 3 , France: col 13
  Mat_EIOPA<-read.xlsx(file=paste(reptravail,"/R4 IN/",Param_EIOPA, sep=""),1, header=TRUE)
  plot(Mat_EIOPA[,sc], main="Taux EIOPA")
  ...
  save(P0t_interp,file = paste(reptravail,"/R4 OUT/",nom_sortie_P0t,".Rda", sep=""))
  #enregistrement des prix f0t dans le repertoire "in"
  save(f0t_liss, file=paste(reptravail,"/R4 OUT/",nom_sortie_f0t,".Rda", sep=""))
