...
# modifiée le: 
#
# Version : 1 (HW marting avec loyers sto)
#
# variables d entree#######################
...
immo <- function(param_calib,Param_EIOPA,sc,Mat_resid_name,nom_sortie,delta_t,reptravail)
  ...
  Infl<-log(1-0.005)*delta_t # % d'inflation sur les loyers immobiliers hors infl monÃ©taire
  ...
  for (i in 1:(Tf)) {
    ...
    RdtImmoL[,i]<-log(1+L0_P0*exp(-RdtImmoCumul+i*Infl)) #loyer
